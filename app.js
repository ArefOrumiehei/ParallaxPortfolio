...
const hiText = document.querySelector('.hiTextContainer')
const hiImg = document.querySelector('.hiImgContainer')
const myName = document.querySelector('.nameContainer h2')
